            ...
            else if (Tex.Equals("Return"))
            {
                inc++;
                    ...
                    if (inc%2==0&&(radioButton1.Checked || radioButton2.Checked || radioButton3.Checked || radioButton4.Checked))
                    {
                        ...
                        {
                            if (string.Equals(radioButton1.Text, q[current]))
                            {
                                label2.Text = "[O] 맞았습니다 " + q[current] + "\n\n" + a[current] + "\n\n" + etc[current] + "\n\n" + h[current];
                            }
                            else
                            {
                                label2.Text = "[X] 틀렸습니다  답은 " + "'" + q[current] + "'" + "\n\n" + etc[current] + "\n\n" + h[current] + " \n 오답노트에 추가되었습니다";
                                wrong();
                            }
                        }
                        else if (radioButton2.Checked)
                        {
                            if (string.Equals(radioButton2.Text, q[current]))
                            {
                                label2.Text = "[O] 맞았습니다 " + q[current] + "\n\n" + a[current] + "\n\n" + etc[current] + "\n\n" + h[current];
                            }
                            else
                        ...
                        {
                            if (string.Equals(radioButton3.Text, q[current]))
                            {
                                label2.Text = "[O] 맞았습니다 " + q[current] + "\n\n" + a[current] + "\n\n" + etc[current] + "\n\n" + h[current];
                            }
                            else
                        ...
                        {
                            if (string.Equals(radioButton4.Text, q[current]))
                            {
                                label2.Text = "[O] 맞았습니다 " + q[current] + "\n\n" + a[current] + "\n\n" + etc[current] + "\n\n" + h[current];
                            }
                            else
                    ...
                    else if(inc%2==1)
                    {
                        ...
                        Array.Sort(o);
                        label1.Text = a[current];
                        radioButton1.Text = q[o[0]];
                        radioButton2.Text = q[o[1]];
                        radioButton3.Text = q[o[2]];
                        radioButton4.Text = q[o[3]];
